...
public class FTUEDialog : Component
{
    ...
    {
        (
            "Loot chests for gear",
            "Chests spawn around the map, look for legendary ones! Better chests have better weapons!",
            "icons/store/vault.png"
        ),
        (
            "Kill to level up",
            "Increases your base damage and chance of finding rare weapons.",
            "icons/bounties/skull_4.png"
        ),
        (
            "Upgrade your weapons",
            "Increase weapon level for cash at the forge, or sell extras for more cash!",
            "forge-icon.png"
        )
    };
    ...
    private static void Draw(float time)
    {
        ...
        if (UI.Button(animatedButtonRect, "Start Playing!", buttonSettings, buttonTs).Clicked)
        {
            Hide();
        }
    }
