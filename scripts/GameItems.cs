...
public class GameItems
{
    ...
    public void CreateItemDefinitions()
    {
        ...
        AkimboPistols = new AkimboPistols(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/weapon_icons/weapon_icons_250x250/akimbo_pistols_alt.png", Id = "akimbo_pistols", Name = "Akimbo Pistols", StackSize = 1 }), ItemRarity.Common, ItemCategory.Weapon);
        Blunderbuss = new Blunderbuss(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/weapon_icons/blunderbuss.png", Id = "__WEAPON__blunderbuss", Name = "Blunderbuss", StackSize = 1 }), ItemRarity.Common, ItemCategory.Weapon);
        PoisonGrenade = new PoisonGrenade(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/ammo_icons/grenade.png", Id = "__WEAPON__poison_grenade", Name = "Poison Grenade", StackSize = 10 }), ItemRarity.Common, ItemCategory.Weapon);
        GatlingGun = new GatlingGun(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/weapon_icons/gatlinggun.png", Id = "__WEAPON__gatling_gun", Name = "Gatling Gun", StackSize = 1 }), ItemRarity.Common, ItemCategory.Weapon);
        WaterBalloonRPG = new WaterBalloonRPG(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/weapon_icons/waterballoonrpg.png", Id = "__WEAPON__water_balloon_rpg", Name = "Water Balloon RPG", StackSize = 1 }), ItemRarity.Common, ItemCategory.Weapon);
        AssaultRifle = new AssaultRifle(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/weapon_icons/assaultrifle.png", Id = "__WEAPON__assault_rifle", Name = "Assault Rifle", StackSize = 1 }), ItemRarity.Common, ItemCategory.Weapon);
        SubmachineGun = new SubmachineGun(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/weapon_icons/smg.png", Id = "__WEAPON__submachine_gun", Name = "Submachine Gun", StackSize = 1 }), ItemRarity.Common, ItemCategory.Weapon);
        ExplosiveShotgun = new ExplosiveShotgun(Item_Definition.Create(new ItemDescription { Icon = "sprites/reusable-weapons/weapon_icons/weapon_icons_250x250/shotgun.png", Id = "__WEAPON__explosive_shotgun", Name = "Explosive Shotgun", StackSize = 1 }), ItemRarity.Common, ItemCategory.Weapon);
